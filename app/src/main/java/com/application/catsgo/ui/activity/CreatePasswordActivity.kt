...
import com.application.catsgo.ui.dialog.SignUpSuccessFragment
...
class CreatePasswordActivity : BaseAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCreatePassword.setOnClickListener {
            if (etPassword1.text.length < 8) {
                ...
                val signUpSuccessFragment = SignUpSuccessFragment()
