...
import com.application.catsgo.adapter.DialogCatAggressionRecyclerAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class CatAggressionFragment : DialogFragment() {

    private val adapter = DialogCatAggressionRecyclerAdapter()
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Agresiflik Seviyesi"
