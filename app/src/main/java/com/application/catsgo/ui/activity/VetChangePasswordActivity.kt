...
import kotlinx.android.synthetic.main.activity_vet_change_password.*

class VetChangePasswordActivity : BaseAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vet_change_password)
