...
import com.application.catsgo.adapter.DialogOccupationRecyclerAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class OccupationFragment : DialogFragment() {

    private val adapter = DialogOccupationRecyclerAdapter()
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Mesleğiniz"
