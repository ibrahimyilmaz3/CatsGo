...
import com.application.catsgo.adapter.YesAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class Sick2Fragment : DialogFragment() {

    private val adapter = YesAdapter()
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Kronik Rahatsızlığı Var mı?"
