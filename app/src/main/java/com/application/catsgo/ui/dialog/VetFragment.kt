...
import com.application.catsgo.adapter.VetAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class VetFragment : DialogFragment() {

    private val adapter = VetAdapter()
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Veteriner Tercihiniz"
