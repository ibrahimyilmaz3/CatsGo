...
import com.application.catsgo.adapter.UserVetRecyclerAdapter
...
import kotlinx.android.synthetic.main.activity_user_appointment.*
...
class UserAppointmentActivity : AppCompatActivity() {
    ...
    private var adapterCard: RecyclerView.Adapter<UserVetRecyclerAdapter.ViewHolder>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapterCard = UserVetRecyclerAdapter()
        rvAppointment.adapter = adapterCard

        linearChooseLocation.setOnClickListener {
            funIntent(UserChooseCityActivity())
        }
        ...
        tvCity.text = ChooseLocation.city
        tvDistrict.text = ChooseLocation.district
        if (ChooseLocation.city != "İl Seçiniz" && ChooseLocation.district != "İlçe Seçiniz") {
            linearChooseDistrict.setBackgroundResource(R.color.none)
        } else {
            linearChooseDistrict.setBackgroundResource(R.drawable.round_20_half_overshadow_right)
        }
