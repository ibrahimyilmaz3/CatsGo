...
import com.application.catsgo.adapter.DialogCatGramRecyclerAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class CatGramFragment : DialogFragment() {

    private val adapter = DialogCatGramRecyclerAdapter()
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Gram"
