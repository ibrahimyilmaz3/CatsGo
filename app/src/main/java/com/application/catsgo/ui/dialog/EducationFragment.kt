...
import com.application.catsgo.adapter.DialogEducationRecyclerAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class EducationFragment : DialogFragment() {

    private val adapter = DialogEducationRecyclerAdapter()
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Eğitim Seviyeniz"
