...
import com.application.catsgo.ui.activity.MainLoginActivity
...
class ForgotFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Şifreniz başarıyla değiştirildi! Yeni şifrenizle giriş yapabilirsiniz."
        view.btnContinue.setOnClickListener {
            funClearIntent(MainLoginActivity())
        }
        return view
    }
