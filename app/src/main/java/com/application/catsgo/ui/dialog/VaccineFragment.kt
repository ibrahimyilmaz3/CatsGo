...
class VaccineFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Eksik Aşısı Var mı?"
        view.tvAllergy.hint = "Eksik Aşı"

        view.linearAllergy.setOnClickListener {
            val noFragment = NoFragment()
            noFragment.show(parentFragmentManager, "noFragment")
            noFragment.result.observe(this) {
