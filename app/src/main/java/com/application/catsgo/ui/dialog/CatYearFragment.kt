...
import com.application.catsgo.adapter.DialogCatYearRecyclerAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class CatYearFragment : DialogFragment() {

    private val adapter = DialogCatYearRecyclerAdapter()
