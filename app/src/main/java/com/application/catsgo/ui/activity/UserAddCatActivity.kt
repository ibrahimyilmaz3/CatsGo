...
import kotlinx.android.synthetic.main.activity_user_add_cat.*

class UserAddCatActivity : BaseAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_user_add_cat)
        ...
        linearCatAge.setOnClickListener {
