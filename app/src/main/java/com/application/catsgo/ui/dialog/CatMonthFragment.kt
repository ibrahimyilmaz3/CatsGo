...
import com.application.catsgo.adapter.DialogCatMonthRecyclerAdapter
import kotlinx.android.synthetic.main.dialog_choose_country.view.*

class CatMonthFragment : DialogFragment() {

    private val adapter = DialogCatMonthRecyclerAdapter()
