...
import com.application.catsgo.ui.activity.VetMyClinicsInfoActivity
import kotlinx.android.synthetic.main.item_my_clinic.view.*

class VetMyClinicRecyclerAdapter : RecyclerView.Adapter<VetMyClinicRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        mainConstItemPet.setOnClickListener {
            val intent = Intent(context as AppCompatActivity, VetMyClinicsInfoActivity::class.java)
