...
import com.application.catsgo.ui.activity.CatsCaredForInfoActivity
import kotlinx.android.synthetic.main.item_pet_care.view.*

class CatsCaredForRecyclerAdapter : RecyclerView.Adapter<CatsCaredForRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder.itemView) {
            mainConstItemPet.setOnClickListener {
                val intent = Intent(context as AppCompatActivity, CatsCaredForInfoActivity::class.java)
